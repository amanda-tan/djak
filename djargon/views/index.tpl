...
<div class="jumbotron">
    <h1>Djargon</h1>
    <p class="lead">Djargon is a cloud processes documentation site built on the Bottle web framework.</p>
    <p><a href="http://bottlepy.org/docs/dev/index.html" class="btn btn-primary btn-large">Bottle &raquo;</a></p>
</div>
